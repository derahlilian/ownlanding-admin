                        ...
                        <div class="card-body p-0">
                                                ...
                                                <td>
                                                    <div class="concierge-bx d-flex align-items-center"
                                                        ...
                                                        <a href="user-details.php">
                                                            <img class="me-3 rounded profile-img"
							...
							<div class="tab-pane" id="Refund">
								<div class="table-responsive">
                                    ...
                                    } elseif (isset($_SESSION["userUpdateError"])) {
                                        echo "<p style='color: red'>Unexpected Error while updating user</p>";
                                    } ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="concierge-bx d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-16 mb-0 text-nowrap"><a class="text-black"
                                                                                                  href="javascript:void(0);"><?php echo $user["name"] . " " . $user["last_name"] ?></a>
                                                            </h5>
                                                ...
                                                <td class="request">
                                                    <a href="/ownlanding-admin/controllers/Administrator.php?editUser&userId=<?php echo $user["id"]; ?>"
                                                ...
                                                <td>
                                                    <div class="request">
                                                        <a href="javascript:void(0);"
                                                           class="btn btn-md text-primary"><?php echo $user["status"] ?? "user status"; ?></a>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="dropdown dropend">
