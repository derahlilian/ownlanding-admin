...
<!-- Mirrored from travl.dexignlab.com/codeigniter/demo/index by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Sep 2024 16:04:51 GMT -->
							...
							<div class="col-xl-6">
								<div class="card">
									...
									<div class="card-body pb-2 loadmore-content" id="BookingContent">
										...
										<div class="rooms mt-3 d-flex align-items-center justify-content-between flex-wrap">
											<div class="d-flex align-items-center mb-3">
												<img src="public/assets/images/room/room1.jpg" alt="">
												<div class="ms-4 bed-text">
													<h4>Queen Bed A-12324</h4>
													<div class="users d-flex align-items-center">
														<img src="public/assets/images/users/user1.jpg" alt="">
														<div>
										...
										<div class="rooms mt-3 d-flex align-items-center justify-content-between flex-wrap">
											<div class="d-flex align-items-center mb-3">
												<img src="public/assets/images/room/room2.jpg" alt="">
												<div class="ms-4 bed-text">
													<h4>Deluxe Room B-1324</h4>
													<div class="users d-flex align-items-center">
														<img src="public/assets/images/users/user2.jpg" alt="">
														<div>
										...
										<div class="rooms mt-3 d-flex align-items-center justify-content-between flex-wrap">
											<div class="d-flex align-items-center mb-3">
												<img src="public/assets/images/room/room3.jpg" alt="">
												<div class="ms-4 bed-text">
													<h4>King Big C-2445</h4>
													<div class="users d-flex align-items-center">
														<img src="public/assets/images/users/user3.jpg" alt="">
														<div >
									...
									<div class="card-footer border-0 m-auto pt-0">
										<a href="javascript:void(0);" class="btn  btn-link m-auto dlab-load-more fs-16 font-w500 text-secondary" id="Booking" rel="public/assets/ajax/booking.html">View more</a>
									</div>
								</div>
							</div>
							<div class="col-xl-6">
								...
								<div class="front-view-slider owl-carousel owl-carousel owl-loaded owl-drag owl-dot">
									<div class="items">
										<div class="customers border">
											...
											<div class="d-flex justify-content-between align-items-center mt-4">
												...
												<img src="public/assets/images/users/user5.jpg" alt="">
												<div class="ms-3">
									...
									<div class="items">
										<div class="customers border">
											...
											<div class="d-flex justify-content-between align-items-center mt-4">
												<div class="customer-profile d-flex ">
												<img src="public/assets/images/users/user6.jpg" alt="">
												<div class="ms-3">
													<h5 class="mb-0"><a href="javascript:void(0);">Kusnaidi Anderson</a></h5>
													<span>4m ago</span>
												</div>
									...
									<div class="items">
										<div class="customers border">
											...
											<div class="d-flex justify-content-between align-items-center mt-4">
												<div class="customer-profile d-flex ">
												<img src="public/assets/images/users/user7.jpg" alt="">
												<div class="ms-3">
													<h5 class="mb-0"><a href="javascript:void(0);">Kusnaidi Anderson</a></h5>
													<span>4m ago</span>
												</div>
...
<!-- Mirrored from travl.dexignlab.com/codeigniter/demo/index by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Sep 2024 16:05:26 GMT -->
</html>