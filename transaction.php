							...
							<table class="table table-sm mb-0 table-striped">
								...
								<tbody id="customers">
									...
									<!-- <tr class="btn-reveal-trigger">
                                        ...
                                        <td>
													<div class="request">
														<a href="javascript:void(0);" class="btn btn-sm text-primary" style="background-color:#D8BFD8 !important;">Refund</a>
													</div>
										</td>
                                        <td class="py-"> <a href=" ">Ref1234567890</a></td>
                                        <td>
													<div class="request">
														<a href="javascript:void(0);" class="btn btn-md text-info" style="background-color:#D8BFD8 !important;">Reversed</a>
													</div>
										</td>
