...
<head>
    ...
    <link href="public/assets/vendor/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet"
          type="text/css"/>
...
***********************************-->
    <div class="nav-header">
        <a href="index.html" class="brand-logo">
            <img src="public/assets/images/ownlogo.png" alt="" width="343" height="66.359"
...
***********************************-->
                                        ...
                                        <div class="card-body">
                                                    ...
                                                    <div class="dropdown dropend ms-auto">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item"
                                                               href="/ownlanding-admin/controllers/Administrator.php?editUser&userId=<?php echo $user["id"]; ?>">Edit</a>
                                                            <a class="dropdown-item" href="javascript:void(0);"
                                                               onclick="confirmDelete()">Delete</a>

                                                        </div>
                                                        <form id="deleteForm"
                                                              action="/ownlanding-admin/controllers/Administrator.php"
                                                              method="POST" style="display: none;">
                                                            <input type="hidden" name="userId" id="fileIdInput"
                                            ...
                                            <?php foreach ($packages as $package): ?>
                                                <div class="d-flex flex-wrap"
                                                     style="background-color: <?php echo "#" . $package['color_code']; ?>;">
                                                    <div class="mt-4 check-status">
                                                    ...
                                                    <div class="mt-4 ms-3">
                                                        ...
                                                        <span class="font-w500 fs-24 text-black"><?php echo $package["package_amount"]; ?><small
    ...
    ***********************************-->
    ...
    <div class="footer">
        <div class="copyright">
            <p>Copyright © Designed &amp; Developed by <a href="https://jamaconcept.com/" target="_blank">Jamasoft
                    Concept</a> 2024</p>
        </div>
    </div>
    <!--**********************************
